...
const Homepage = ({row}) => {
  ...
  return (
    <div id="homepage" style={{ width: '100%', height: '100vh', backgroundImage: 'url("./homepagebg.jpg")', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundSize: 'cover',overflowX:'hidden',color:'white'}}>
      <Stack sx={{ background: 'rgba(0,0,0,0.5)', width: '100%', height: '100vh', }}>
        <Grid container spacing={2} columns={12} sx={{ height: '60px', margin: 0, display: 'flex', alignItems: 'center',postion:'fixed',}}>
          <Grid item xs={12} md={6}>
            <IconButton>

              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="white" class="bi bi-xbox" viewBox="0 0 16 16">
          ...
          <Grid item xs={12} md={6} sx={{ display: 'flex', justifyContent: 'flex-end', pr: 5 }}>
